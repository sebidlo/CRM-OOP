...
$company2 = new Company(2, "firma 222");
...
new Activity(3, "Nawiązanie kontaktu", new DateTime("2018-03-01 14:00"), $company, $salesman3, ActivityType::METTONG, ActivityStatus::IN_PROGRES, "notatka JALDANDNADA")
);
